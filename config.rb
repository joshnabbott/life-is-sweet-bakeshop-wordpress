...
config[:author_uri] = "http://www.joshnabbbott.com"

# Description of the theme
config[:description] = "Wordpress theme made specifically for Life is Sweet Bakeshop (my wife, Liz's, awesome bakery)"
